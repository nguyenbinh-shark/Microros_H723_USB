...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level: Enable ALL CAN 1, 2 & 3 transceivers (PC13, PC14, PC15 HIGH) */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, CS_Pin|GPIO_PIN_13, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : CS_Pin PE13 */
  GPIO_InitStruct.Pin = CS_Pin|GPIO_PIN_13;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
