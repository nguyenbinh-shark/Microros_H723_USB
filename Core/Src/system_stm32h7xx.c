...
/* Must match stm32h7xx_hal_conf.h. CyberGear CAN baud = PLL2Q/(4*25);
 * with HSE=24 MHz, PLL2M=24,N=200,Q=2 => PLL2Q=100 MHz => 1.0 Mbps.
 * If the board actually has a 25 MHz crystal, set PLL2M=25 in main.c instead. */
